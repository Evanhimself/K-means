...
def mask_images(image_dir, 
    ...
    return ori_img, patch_list, label_list
...
if __name__ == '__main__':
    ...
    rough_ori_img, rough_patch, rough_label = mask_images('./rough', 
                                                            1, 
                                                            source_size, 
                                                            patch_size)
    ...
    smooth_ori_img, smooth_patch, smooth_label = mask_images('./smooth', 
                                                            2, 
                                                            source_size, 
                                                            patch_size)
